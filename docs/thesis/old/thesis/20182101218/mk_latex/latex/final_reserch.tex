...
{[}File作られる画像{]}. \label{sample}(docs/picture/mkdir.png)
...
\begin{center}
\includegraphics[width=150mm]{../../picture/random_h.rb.png}
\end{center}
...
\centering
\begin{center}
\includegraphics[width=150mm]{../../picture/sequential_h.rb.png}
\end{center}
\caption{picture/sequential\_h.rb.png}
