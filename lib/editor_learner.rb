...
module EditorLearner
    ...
    desc 'sequential_check', 'sequential check your typing and edit skill'

#    def sequential_check(*argv)
#      random_sequential = rand(1..4)
#      s = "#{random}.rb"
#      puts "check starting ..."
#      puts "typing following commands on the terminal"
